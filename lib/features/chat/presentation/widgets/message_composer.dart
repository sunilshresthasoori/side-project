...
class _MessageComposerState extends State<MessageComposer> {
  ...
  void initState() {
    ...
    _controller.addListener(() {
      ...
      context
          .read<ChatDetailBloc>()
          .add(ChatDetailMessageChangedEvent(_controller.text));
    });
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.replyToMessage != null)
              _ReplyBanner(message: widget.replyToMessage!),
        ...
        child: Row(
          children: [
            ...
            GestureDetector(
              onTap: () => context
                  .read<ChatDetailBloc>()
                  .add(const ChatDetailReplyClearedEvent()),
              child: Container(
                width: 24,
                height: 24,
                decoration: BoxDecoration(
                    color: AppColors.snowFog, shape: BoxShape.circle),
